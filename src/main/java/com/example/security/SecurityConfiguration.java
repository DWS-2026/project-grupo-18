        ...
        public SecurityFilterChain apiFilterChain(HttpSecurity http) throws Exception {
                ...
                http
                                .authorizeHttpRequests(authorize -> authorize
                                                ...
                                                .hasRole("ADMIN")
                                                .requestMatchers(HttpMethod.DELETE, "/api/v1/certifications/**")
                                                .hasRole("ADMIN")
                                                ...
                                                // SHOPPING CART API
                                                .requestMatchers(HttpMethod.GET, "/api/v1/shopping-cart-items/me")
                                                .authenticated()
                                                .requestMatchers(HttpMethod.GET,
                                                                "/api/v1/shopping-cart-items/me/certifications")
                                                .authenticated()
                                                .requestMatchers(HttpMethod.GET, "/api/v1/shopping-cart-items/{id}")
                                                .authenticated()
                                                .requestMatchers(HttpMethod.POST, "/api/v1/shopping-cart-items/**")
                                                .authenticated()
                                                .requestMatchers(HttpMethod.DELETE, "/api/v1/shopping-cart-items/**")
                                                .authenticated()
                                                .requestMatchers(HttpMethod.GET, "/api/v1/shopping-cart-items/user/**")
                                                .hasRole("ADMIN")
                ...
                http.sessionManagement(
                                management -> management.sessionCreationPolicy(SessionCreationPolicy.IF_REQUIRED));
